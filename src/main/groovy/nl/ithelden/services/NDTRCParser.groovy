...
class NDTRCParser {
    ...
    static TRCItem parseTRCItem(Element trcItemElement) {
        TRCItem trcItem = new TRCItem(
            ...
            published: trcItemElement.attributeValue('published') ? Boolean.parseBoolean(trcItemElement.attributeValue('published')) : Boolean.TRUE,
            ...
            deleted: trcItemElement.attributeValue('deleted') ? Boolean.parseBoolean(trcItemElement.attributeValue('deleted')): Boolean.FALSE,
            validatedby: trcItemElement.attributeValue('validatedby'),
            offline: trcItemElement.attributeValue('offline') ? Boolean.parseBoolean(trcItemElement.attributeValue('offline')): Boolean.FALSE,
